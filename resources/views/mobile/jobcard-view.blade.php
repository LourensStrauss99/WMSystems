        ...
        @foreach($jobcards as $jobcard)
            <div style="background: #fff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.04); padding: 1rem; display: flex; flex-direction: column; align-items: flex-start;">
                ...
                <div style="display: flex; gap: 0.5rem;">
                    ...
                    <a href="{{ route('mobile.jobcards.edit', $jobcard->id) }}" style="background: #f3f4f6; color: #2563eb; border: 1px solid #2563eb; border-radius: 4px; padding: 0.4rem 1rem; text-decoration: none; font-size: 0.95rem;">View</a>
                </div>
            </div>
        @endforeach
    </div>
