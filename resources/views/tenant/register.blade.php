...
<head>
    ...
    <title>Register Your Company - Workflow Management System</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="text-muted small">
                                    ...
                                    We'll create a secure isolated database for your company
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <p class="text-muted small mb-3">This will be the main administrator account for your company with Level 5 Super Admin privileges</p>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="bg-light rounded-3 p-4 mb-4">
                                    <h6 class="fw-bold mb-2">
                                        <i class="fas fa-gift me-2 text-success"></i>30-Day Free Trial
                                    </h6>
                                    <p class="mb-2 small">✓ Complete workflow management system</p>
                                    <p class="mb-2 small">✓ Unlimited users and jobcards</p>
                                    <p class="mb-2 small">✓ Inventory management</p>
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary btn-lg w-100">
                                    <i class="fas fa-rocket me-2"></i>Create My Company Account
                                </button>
                            </div>
