...
@section('content')
    ...
    <div class="container">
        ...
        @if($jobcards)
            <!-- Red Test Sign -->
            <div style="background-color: red; color: white; padding: 10px; text-align: center; font-weight: bold; margin-bottom: 10px;">
                TEST SIGN
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        for (let row of rows) {
            row.addEventListener('click', function(e) {
                ...
                this.classList.add('tr-highlight');
            ...
            .then(data => {
                ...
                data.data.forEach(jobcard => {
                    ...
                    tr.addEventListener('click', function(e) {
                        console.log('New row clicked:', this);
                        e.preventDefault();
                        e.stopPropagation();
                        document.querySelectorAll('#jobcardTable tr.tr-highlight').forEach(function(tr) {
                            tr.classList.remove('tr-highlight');
